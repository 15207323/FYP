<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <?php echo form_open("ResttInfo/edit/".$rest[0]->restID); ?>

    <div class="form-group">

        <label for="restID" class="col-sm-4 control-label">rest ID</label>
        <div class="col-sm-8">
            <input type="text" disabled="disabled" class="form-control" name="restID" value="<?php echo $rest[0]->restID; ?>" style="margin-bottom:10px;">
        </div>
        ...
        <div class="col-sm-8">
            ...
            <input type="number" class="form-control" name="restAvgPrice" step="1" value="<?php echo set_value('restAvgPrice'); ?>" style="margin-bottom:10px;">
        </div>
