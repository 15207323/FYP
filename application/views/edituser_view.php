...
//    ?>
    <?php echo form_open("UserInfo/edit/". $member[0]->memberName); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" disabled="disabled" class="form-control" name="memberPoint" value="<?php echo $member[0]->memberPoint; ?>" style="margin-bottom:20px;">
        </div>
