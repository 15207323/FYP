...
<div class="container">
    ...
    <div class="col-sm-12 row" style="margin-bottom: 40px; margin-right:100px">
        ...
        <a type="button" class="btn btn-default" href="<?php echo site_url("CouponInfo/edit/$coupon->couponID"); ?>" role="button" style="margin-right: 30px">Edit</a>
        <a type="button" class="btn btn-default" href="<?php echo site_url("CouponInfo/admindelete/$coupon->couponID"); ?>" role="button" style="margin-right: 30px">Delete</a>


    </div>

    <a type="button" class="btn btn-default" style="margin-top: 40px" href="<?php echo site_url("CouponInfo"); ?>"" role="button">Back</a>
