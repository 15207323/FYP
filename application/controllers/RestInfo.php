...
class RestInfo extends CI_Controller
{
    ...
    public function view($id = '') {
        ...
        if($this->session->userdata('logged_in')){
            ...
            $this->data['restInfo']=$this->GetRestInfo_model->get_particular_restaurant($id);
    ...
    public function edit($id) {
        ...
        $this->GetRestInfo_model->get_particular_restaurant($id);
        ...
        if (!$this->input->post('post')) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($this->input->post('restAvgRate') != NULL) {
                    $inputdata['restAvgRate'] = $this->security->xss_clean($this->input->post('restAvgRate'));
                }
